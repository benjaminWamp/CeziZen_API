...
// import { articleImageUploadOpts } from './upload.config';
...
export class ArticleImageController {
  ...
  async uploadFile(@UploadedFile() file: File) {
    ...
    const image: { id: number; path: string } =
      await this.articleImageService.create({ path });
